...
2.Author APIs for creating a new product, fetching a product, fetching a list of products, updating products (including deletion),all APIs will only perform in-memory operations
